...
const CATEGORIES = ['All', 'Heritage', 'Religious', 'Nature', 'Food & Culture', 'Architecture', 'Historical'];
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <TouchableOpacity
                  ...
                  <View style={[styles.placeImg, { backgroundColor: item.type === 'landmark' ? '#dbeafe' : '#dcfce7' }]}>
...
const styles = StyleSheet.create({
  ...
  // List
  sectionTitle: { fontSize: scale(15), fontWeight: '700', color: Colors.textPrimary, paddingHorizontal: Spacing.lg, marginTop: Spacing.md, marginBottom: Spacing.sm },
